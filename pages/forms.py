...
class PersonForm(forms.ModelForm):
    class Meta:
        model = Person
        fields = [
            'full_name', 'cpf', 'phone', 'birth_date',  # REMOVIDO 'email'
...
class CompanyForm(forms.ModelForm):
    class Meta:
        model = Company
        fields = [
            'corporate_name', 'trade_name', 'cnpj', 'phone',  # REMOVIDO 'email'
        ...
        widgets = {
            ...
            # REMOVIDO: 'email': forms.EmailInput(attrs={'class': 'form-control'}),
            'phone': forms.TextInput(attrs={'class': 'form-control', 'placeholder': '(00) 00000-0000'}),
            'address': forms.TextInput(attrs={'class': 'form-control'}),
            'city': forms.Select(attrs={'class': 'form-control'}),
